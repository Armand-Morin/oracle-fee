...
async function main() {
  ...
  const linkTokenAddress = "0x326C977E6efc84E512bB9C30f76E30c160eD06FB"; // LINK token address on goerli
  const signer = (await hre.ethers.getSigners())[0]; // Adjust if your signer is different
  const linkToken = new Contract(linkTokenAddress, ["function transfer(address to, uint amount) returns (bool)"], signer);
